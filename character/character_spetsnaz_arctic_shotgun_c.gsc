...
main()
{
	codescripts\character::setModelFromArray(xmodelalias\alias_spetsnaz_arctic_shotgun_bodies::main());
...
precache()
{
	codescripts\character::precacheModelArray(xmodelalias\alias_spetsnaz_arctic_shotgun_bodies::main());
