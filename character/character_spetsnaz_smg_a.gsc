...
main()
{
	codescripts\character::setModelFromArray(xmodelalias\alias_spetsnaz_smg_bodies::main());
...
precache()
{
	codescripts\character::precacheModelArray(xmodelalias\alias_spetsnaz_smg_bodies::main());
