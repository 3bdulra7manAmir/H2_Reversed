...
main()
{
    ...
    level._id_B8AB = "vb_us_army"; //here
    level._id_C0C9 = 1;
    level._id_C7C3 = 1;
    _id_CFD6::main();
    _id_AC9E::main();
    ...
    maps\_load::set_player_viewhand_model( "spetsnaz_vh" );
    maps\_drone_ai::init();
...
_id_C341()
{
    ...
    if ( self.script_noteworthy == "rappel_guard_1" )
    {
        ...
        // codescripts\character::setheadmodel( "head_shadow_co_c" );
    ...
    else if ( self.script_noteworthy == "rappel_guard_2" )
    {
        ...
        // codescripts\character::setheadmodel( "head_shadow_co_b" );
    }
}
