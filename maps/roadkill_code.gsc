...
_id_C80F()
{
    ...
    level.foley.name = "Val. Makarov - Ultranationalist"; //here
...
{
    level._id_ACC0 = self;
    level._id_ACC0.name = "Pvt. Yuri - Ultranationalists";
    self.animname = "dunn";
    maps\_utility::make_hero();
}
...
{
    level._id_B416 = self;
    level._id_B416.name = "Gen. Zakhaev - Ultranationalists";
...
_id_A9A3()
{
    ...
    var_4 setmodel( "spetsnaz_player_vh" ); //here
...
_id_AA6D()
{
    ...
    return level.player getcurrentweapon() == "gp-25"; //here
}
