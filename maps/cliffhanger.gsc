...
main()
{
    ...
    var_4.script_friendname = "Capt. Makarov - Ultranationalist";
    level._id_AFD9 = 500;
    level._id_C6AC = 200;
    level._id_B65E = 1;
    level._id_CC42 = 1;
...
_id_C9AE()
{
    ...
    level.scr_model["player_rig"] = "viewhands_player_arctic_wind"; //here
...
_id_C5D7()
{
    ...
    level.price maps\_utility::forceuseweapon( "usp_silencer", "primary" );
    //here
    // level.price maps\cliffhanger_code::setheadmodel( "head_hero_soap_arctic_interior" );
    //level.price.name = "Soap - Task Force 141";
    //level.price maps\cliffhanger_code::setheadmodel( "head_shadow_co_c" );
    maps\_utility::autosave_stealth();
...
_id_D17D()
{
    ...
    level.scr_model["worldbody"] = "viewbody_arctic"; //here
    maps\_load::set_player_viewhand_model( "viewhands_player_arctic_wind" );
    level.scr_model["player_rig"] = "viewhands_player_arctic_wind"; //here
}
