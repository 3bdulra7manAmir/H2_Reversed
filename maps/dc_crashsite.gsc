...
main()
{
    ...
    precachemodel( "vb_us_army_injured" );
...
_id_B0C4()
{
    ...
    codescripts\character::setheadmodel( "head_airborne_a" ); //here
    character\character_spetsnaz_assault_a::main(); //here
    level._id_AC03 hide();
    level._id_C280 hide();
    level._id_BBBD hide();
    level._id_C280.name = "Pvt. Yuri - Ultranationalist"; //here
    level._id_AC03.name = "Val. Makarov - Ultranationalist"; //here
    ...
    level._id_CE77 setmodel( "kriss" ); //h2_viewmodel_masada_acog_digital
...
_id_ABAD()
{
    ...
    level.scr_model["player_rig"] = "vb_us_army_injured"; //here
