...
_id_B044()
{
    ...
    foreach ( var_2 in self.riders )
    {
        if ( isai( var_2 ) )
        {
            ...
            {
                //var_2 character\random_seal::main();
            }
        }
    }
}
...
_id_D5A3()
{
    ...
    {
        level.player giveweapon( "masada_digital_reflex" );
        level.player switchtoweapon( "masada_digital_reflex" );
        thread _id_C0C3::weapons_specialfeatures();
        return;
    }
...
_id_BEEC()
{
    ...
    //character\character_opforce_merc_lmg_a_oilrig_b::main();
    //maps\_custom_utility::detach_all_attachments();
