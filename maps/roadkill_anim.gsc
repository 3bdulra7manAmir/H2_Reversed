...
_id_B845()
{
    ...
    level.scr_model["player_rig"] = "spetsnaz_player_vh";
    level.scr_animtree["viewbody"] = #animtree;
    level.scr_model["viewbody"] = "vb_us_army";
    level.scr_animtree["player_worldbody"] = #animtree;
    level.scr_model["player_worldbody"] = "vb_us_army";
...
_id_ADA7()
{
    ...
    level._id_D115["h2_intro_vehicle"]["angles"] = ( 0, 0, 0 );
}
